                  ...
                  <div class="card card-primary bg-primary card-outline" style="padding-top: 3px">
                    <div class="card-body box-profile bg-light">
                      <div class="text-center">
                          ...
                          <?php if ($admin[0]['image'] == 'default.png') { ?>
                            ...
                            <?php }  else { ?>
                          <img class="profile-user-img img-fluid img-circle" src="../../img/teachers/<?php echo $admin[0]['image']; ?>" style="height: 125px; width: 120px; border-radius:50%" alt="User profile picture">
                          <?php } ?>
                        </a>
                      </div>

                      <h5 class="profile-username text-center mt-3"><?php echo $admin[0]['firstname'] . " " . $admin[0]['lastname']; ?></h5>
                      <p class="card-text text-center" style="margin-top:-10px">Department of <?php echo $admin[0]['department']; ?></p>
                      ...
                      <form action="profile/update_image.php" method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="modal-body text-right">
                          <div class="form-group">
                            <input type="hidden" name="old_image" value="<?php echo $admin[0]['image']; ?>" class="form-control">
                  ...
                  <form action="" id="update_password" method="post" class="w-100 mx-0 px-0">
                    <div class="card card-success bg-success card-outline" style="padding-top: 3px">
                      <div class="card-body box-profile bg-light">
                        ...
                        Confirm Password
                        <div class="input-group input-group-sm mb-2">
                          <input type="password" name="confirm_password text-center" autocomplete="off" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                ...
                <div class="card-body pt-2 px-5" style="background: #FFFFFF">
                  <form action="profile/update_info.php" id="update_info" method="post" class="w-100">
                    ...
                    <div class="input-group mb-3">
                      <input name="firstname" type="text" class="form-control" value="<?php echo $admin[0]['firstname']; ?>">
                    </div>
                    Last Name
                    <div class="input-group mb-3">
                      <input name="lastname" type="text" class="form-control" value="<?php echo $admin[0]['lastname']; ?>">
                    </div>
                    Username
                    <div class="input-group mb-3">
                      <input name="username" type="text" class="form-control" value="<?php echo $admin[0]['username']; ?>">
                    </div>
                    Mobile
                    <div class="input-group mb-3">
                      <input type="text" name="mobile" class="form-control" value="<?php echo $admin[0]['mobile']; ?>">
                    </div>
                    Email
                    <div class="input-group mb-3">
                    ...
                    Department
                    <div class="input-group mb-3">
                      <input name="department" style="text-transform: capitalize" type="text" class="form-control" value=" <?php echo $admin[0]['department']; ?>">
                    </div>

                    <button type="button" class="btn btn-primary my-0" data-toggle="modal" data-target="#updateInfo">
                      Update
                    </button>
