    ...
    <div class="main">
      <?php include 'partials/navbar.php'; ?>
       ...
       <div class="container pt-2">
        ...
        <form class="w-100" action="question/check_short_question_submit.php" method="POST">
            ...
            <?php foreach ($short_exam_detail as $key => $question) { ?>
                <div class="col-12 pl-5">
                  ...
                  <p style="margin-left:20px; margin-top: -12px">
                        ...
                        <input style="font-size:12px; border:1px solid black" placeholder="Give mark" max="<?php echo $question['mark']; ?>" type="number" name="achieve_marks[<?php echo $key; ?>]">
                  </p>
